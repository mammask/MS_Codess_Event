...
According to the results of the \`KPSS\` test, we fail to reject the null hypothesis and therefore the series is not stationary.
...
According to the results of the ADF test, we reject the null hypothesis and therefore the series is not stationary.
...
```{r fig 14,  fig.height = 4, fig.width = 8}
# Convert to time series object
